    ...
    >
      ...
      >
        <div className="h-48 w-full relative rounded-t-lg">
          <Image
            className="w-full h-48 object-cover rounded-md rounded-t-lg"
        ...
        <div className="relative bg-transparent rounded-lg text-white text-sm p-2">
          ...
          <div className="grid grid-cols-2 gap-y-2 gap-x-1">
            <div className="flex justify-start items-center">
              ...
              />
              <p className="break-all ltr:text-left rtl:text-right px-2 pt-1 line-clamp-1">
            ...
            <div className="flex justify-start items-center">
              <Image
                ...
                className={`w-1/6  h-6 object-contain mt-2`}
                suppressHydrationWarning={suppressText}
                priority={false}
              />
              <p
