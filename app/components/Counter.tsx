...
const Counter: FC<Props> = ({
  ...
  iconClr = '',
  iconSize = 18,
  inputClassName = 'bg-primary_BG outline-none text-center border-none text-white py-2 mx-2 w-10 h-6',
  containerClassName = '',
}): JSX.Element => {
  return (
    <div className={containerClassName + ' flex justif-center items-center'}>
      <div className="cursor-pointer" onClick={(e)=>{e.stopPropagation(); dec()}}>
