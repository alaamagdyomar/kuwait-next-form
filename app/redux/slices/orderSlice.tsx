...
export const orderSlice = createSlice({
  ...
  reducers: {
    ...
    // to reset invoice and order id before every order
    //  to know the method of payment in order success and failure
...
export const { setOrder, resetOrder, toggleIsEmpty, orderMade ,resetOrderIdInvoice} =
  orderSlice.actions;
